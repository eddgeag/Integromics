...
directorio.totales <- "./scripts_R/IP/resultados_totales_multivariante"

if(!dir.exists(directorio.totales)){
  dir.create(directorio.totales)
}

directorio.comunes <- "./scripts_R/IP/resultados_comunes_multivariante"
