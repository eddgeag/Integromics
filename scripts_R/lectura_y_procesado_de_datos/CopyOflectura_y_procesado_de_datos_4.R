...
for (cond in conds) {
  ...
  if (!dir.exists("../../datos/resultados_analisis_datos_procesados_1000_mean_0_3")) {
    dir.create("../../datos/resultados_analisis_datos_procesados_1000_mean_0_3")
  }
  
  saveRDS(datos.integromics,
          file.path(
            paste0(
              "../../datos/resultados_analisis_datos_procesados_1000_mean_0_3/resultados_analisis_datos_procesados_1000_mean_0_3",
              "_",
              cond,
              "_",
              ".rds"
