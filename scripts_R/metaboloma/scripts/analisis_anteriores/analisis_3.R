...
add_classificacion_metaboloma <- function(X, metaboloma) {
  ...
  aa <- colnames(metaboloma)[c(33, 15, 20, 19, 23)]
  carbo <-
...
write.csv(interpretacion,"./12-2-22/scripts_analysis_reunion/scripts_metaboloma2/Resultados_univariante_metaboloma/interpretacion.csv")
